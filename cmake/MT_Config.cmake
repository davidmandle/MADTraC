...
if(NOT MSVC)
  ...
  set(MT_GUI_LIBS ${MT_LIBS_DIR}/libMT_GUI.a ${MT_CORE_LIBS})
...
function(MT_Require_Version APP_NAME MIN_VERSION)
  string(REGEX MATCH "[0-9]+\\." REQ_MAJ ${MIN_VERSION})
  string(REGEX MATCH "[0-9]+" REQ_MAJ ${REQ_MAJ})
  string(REGEX MATCH "\\.[0-9]+\\." REQ_MIN ${MIN_VERSION})
  string(REGEX MATCH "[0-9]+" REQ_MIN ${REQ_MIN})
  string(REGEX MATCH "\\.[0-9]+$" REQ_PATCH ${MIN_VERSION})
  string(REGEX MATCH "[0-9]+" REQ_PATCH ${REQ_PATCH})
  math(EXPR REQ_VERSION_NUMBER "${REQ_MAJ}*10000 + ${REQ_MIN}*100 + ${REQ_PATCH}")
  if(MT_VERSION_NUMBER LESS REQ_VERSION_NUMBER)
    message(FATAL_ERROR "${APP_NAME} requires MADTraC version ${MIN_VERSION}, but you have ${MT_VERSION}")
  endif()
endfunction(MT_Require_Version)  