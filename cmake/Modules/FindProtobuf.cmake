...
function(PROTOBUF_GENERATE_CPP SRCS HDRS)
  ...
  foreach(FIL ${ARGN})
	...
	message(--cpp_out --matlab_out ${CMAKE_CURRENT_BINARY_DIR} ${_protobuf_include_path} ${ABS_FIL})
    add_custom_command(
      OUTPUT "${CMAKE_CURRENT_BINARY_DIR}/${FIL_WE}.pb.cc"
             "${CMAKE_CURRENT_BINARY_DIR}/${FIL_WE}.pb.h"
      COMMAND  ${PROTOBUF_PROTOC_EXECUTABLE}
      ARGS --cpp_out ${CMAKE_CURRENT_BINARY_DIR} --matlab_out ${CMAKE_CURRENT_BINARY_DIR} ${_protobuf_include_path} ${ABS_FIL}	  
      DEPENDS ${ABS_FIL}
...
find_file(FIND_PACKAGE_HANDLE_FILE "FindPackageHandleStandardArgs.cmake" PATHS ${CMAKE_MODULE_PATH_STR})

include("${FIND_PACKAGE_HANDLE_FILE}")
